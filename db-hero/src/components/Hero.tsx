    ...
    <div className="container hero__grid">
      <div className="hero__copy">
        ...
        <p className="hero__lede">
          We build custom restaurant ordering platforms, multi-branch systems, admin
          dashboards and digital operations — tailored to your business.
        </p>
      ...
      <div className="hero__visual" aria-label="Illustrative preview of a restaurant ordering app and admin dashboard">
        <div className="hero__browser"><BrowserMock screen="admin" /></div>
        <div className="hero__phone hero__phone--1"><PhoneMock screen="menu" /></div>
        <div className="hero__phone hero__phone--2"><PhoneMock screen="tracking" /></div>
